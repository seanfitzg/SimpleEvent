...
describe('EventStore basic functions', function() {
    ...
    function orderSubmitted(eventData) {
        var order = {}
        order.productId = eventData.productId;
        order.unitPrice = eventData.unitPrice;
        order.quantity = eventData.quantity;
        return order;
    };

    function quantityUpdated(eventData, order) {;
        order.quantity = eventData.quantity;
        return order;
    };
